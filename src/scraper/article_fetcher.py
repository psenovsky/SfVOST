...
def nacti_z_ukazku_csv(cesta_csv):
    ...
    for raw_radek in raw_radky:
        ...
        if raw_radek["Plné znění"] == "":
            if raw_radek["Zdroj"] in ("czpravy.cz", "auto.tn.nova.cz", "tn.cz", "tnbiz.cz", "cssd.cz", "cz.sputniknews.com", "vrbnopp.cz", "belkovice-lastany.cz", "enviweb.cz", "firststyle.cz", "mesto-beroun.cz", "asocr.cz", "mediashow.cz", "praha16.eu", "energy-hub.cz", "irozhlas.cz", "halonoviny.cz"):
